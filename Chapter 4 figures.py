...
#code source adapted from https://andresramirezhassan-introduction-bayesian-econometrics-gui.share.connect.posit.cloud/logit-model.html
#and . Martin. Stat 591 Notes – Logistic Regression and Metropolis–Hastings Example, Nov.2013. Course notes.
...
#all discretisation schemes code can be found online in referenced sources
