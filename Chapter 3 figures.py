...
#we are looking at a classical nesterov example, many public resources available, the plots just zooms in  
#on later times to show oscillatory behaviour as time goes on.
a= 0.02
